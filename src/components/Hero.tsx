...
export default function Hero() {
  ...
  return (
    <section
      ref={containerRef}
      className={`relative min-h-screen flex flex-col lg:flex-row items-center justify-center lg:justify-between px-8 md:px-20 overflow-hidden ${bgGradient} pt-20 pb-32`}
      id="home"
    >
      ...
      <motion.div
        ...
        className="relative z-10 w-full flex justify-center lg:justify-start mb-12 lg:mb-0"
      >
        ...
        <div className="relative">
          ...
          {/* Your Photo */}
          <div className={`relative w-64 h-64 md:w-80 md:h-80 lg:w-96 lg:h-96 rounded-full overflow-hidden border-4 ${
      ...
      <motion.div style={{ y, opacity }} className="relative z-10 max-w-3xl">
        <motion.div
          ...
          className="mb-4"
        >
          <span className={`text-xl flex items-center gap-2 justify-center lg:justify-start ${
        ...
        <motion.h1
          ...
          className="text-5xl md:text-7xl font-bold mb-6 leading-tight text-center lg:text-left"
        >
        ...
        >
          <motion.a
            href="/contact"
            className="relative w-40 h-40 rounded-full border-2 border-lime-400 flex items-center justify-center cursor-pointer group"
